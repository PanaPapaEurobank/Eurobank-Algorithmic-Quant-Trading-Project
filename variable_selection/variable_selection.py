...
lasso_results_1 = asset_selector.dominant_asset_selection("lasso", "chunks")
lasso_results_2 = asset_selector.dominant_asset_selection("lasso", "loop")
ridge_results_1 = asset_selector.dominant_asset_selection("ridge", "chunks")
ridge_results_2 = asset_selector.dominant_asset_selection("ridge", "loop")